...
const CostCheck = (): JSX.Element => {
  ...
  return (
    <>
      ...
      <Head>
        <title>Cek ongkir - Lihat Ongkos Kirim Paket</title>
      </Head>
      <Header />
      <div className="px-4 lg:px-32 pb-20">
        <Hero title="Cek Ongkir" description="Cek ongkir dari berbagai kurir ekspedisi Indonesia, cepat dan akurat." />
        ...
        <div className="col-span-2 mt-28 lh-lg mb-10">
          ...
          <h3 className="text-2xl mt-8 font-roboto font-medium mb-4">1. Bisa Memilih Ekspedisi Sesuai Kebutuhan</h3>
          ...
          <h3 className="text-2xl mt-8 font-roboto font-medium mb-4">2. Bisa Mempertimbangkan Biaya Operasional</h3>
          ...
          <h3 className="text-2xl mt-8 font-roboto font-medium mb-4">3. Bisa Mengambil Keputusan Terkait Jual Beli</h3>
          ...
          <h3 className="text-2xl mt-8 font-roboto font-medium mb-4">1. JNE</h3>
          ...
          <h3 className="text-2xl mt-8 font-roboto font-medium mb-4">3. SiCepat</h3>
          ...
          <h3 className="text-2xl mt-8 font-roboto font-medium mb-4">4. Pos Indonesia</h3>
          ...
          <h3 className="text-2xl mt-8 font-roboto font-medium mb-4">5. Wahana</h3>
          ...
          <h3 className="text-2xl mt-8 font-roboto font-medium mb-4">6. ID Express</h3>
          ...
          <h3 className="text-2xl mt-8 font-roboto font-medium mb-4">8. Lion Parcel</h3>
