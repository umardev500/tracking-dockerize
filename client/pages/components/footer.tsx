      ...
      <footer className="px-4 lg:px-32 border-t mt-10">
        <div className="pb-8 pt-10">
          <ul className="flex justify-center flex-wrap">
            ...
            <li>
              <a onClick={openModal} href="#blank" className="text-gray-500 font-roboto px-4 mb-2 inline-flex">
                Contact
              </a>
            </li>
            <li>
            ...
            <li>
              <Link href="/cek-ongkir">
                <a href="#blank" className="text-gray-500 font-roboto px-4 mb-2 inline-flex whitespace-nowrap">
                  Cek Ongkir
                </a>
              </Link>
            </li>
